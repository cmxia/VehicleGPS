...
{
    public sealed class OilCheckWebService
    {
        ...
        private void RequestReady(IAsyncResult asyncResult)
        {
            ...
            basicInfo = ReportTreeViewModel.GetInstance().SelectedNode;
        ...
        public DataTable getCurrentOilDT()
        {
            DataTable dt = null;
            dt = JsonHelper.JsonToDataTable(result);
            return dt;
        }
    }
}
