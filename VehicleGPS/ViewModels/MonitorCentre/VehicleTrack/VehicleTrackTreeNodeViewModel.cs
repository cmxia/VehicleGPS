...
{
    class VehicleTrackTreeNodeViewModel : NotificationObject
    {
        ...
        /*子节点*/
        public List<VehicleTrackTreeNodeViewModel> listChildNodes;
        public List<VehicleTrackTreeNodeViewModel> ListChildNodes
        {
        ...
        /*父节点*/
        public VehicleTrackTreeNodeViewModel parentNode;
        public VehicleTrackTreeNodeViewModel ParentNode
        {
        ...
        //private void SelectedGPSInfo(VehicleTrackTreeNodeViewModel CurrentNode)
        //{
        //    VehicleTrackTreeNodeViewModel parentNode = CurrentNode;
        //    /*找到根节点*/
        //    while (parentNode.nodeInfo.ID != "admin")
        //    {
        //        parentNode = parentNode.parentNode;
        //    }
        //    List<VehicleTrackItemViewModel> listTmp = new List<VehicleTrackItemViewModel>();
        //    GetSelectedVehicleDetailInfo(parentNode, listTmp);
        //    VehicleTrackViewModel trackPlayVM = VehicleTrackViewModel.GetInstance();
        //    trackPlayVM.ListVehicleInfo.Clear();
        //    trackPlayVM.ListVehicleInfo = listTmp;
        //}
        //private void GetSelectedVehicleDetailInfo(VehicleTrackTreeNodeViewModel node, List<VehicleTrackItemViewModel> listTmp)
        //{
        //    if (node.listChildNodes != null)
        //    {
        //        foreach (VehicleTrackTreeNodeViewModel vtnvm in node.listChildNodes)
        //        {
        //            GetSelectedVehicleDetailInfo(vtnvm, listTmp);
        //        }
        //    }
        //    else
        //    {
        ...
        //                    {
        //                        VehicleTrackItemViewModel itemVM = new VehicleTrackItemViewModel();
